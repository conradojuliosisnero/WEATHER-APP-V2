    ...
    <section className="relative flex gap-2">
      <div>
        <input
          ...
          name="city-search"
          className="w-full pl-10 pr-4 py-2 rounded-full bg-white bg-opacity-20 backdrop-blur-lg text-white placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-white"
        />
