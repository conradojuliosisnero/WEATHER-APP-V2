...
export default function SearchSection() {
  ...
  return (
    <section className="relative flex justify-between gap-2">
      <div>
        <input
          type="text"
          ...
          name="city-search"
          className="w-full pl-10 pr-4 py-2 rounded-full bg-white text-white placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-white"
        />
